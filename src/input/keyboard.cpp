...
Keyboard::Keyboard(Window *wind) : window(wind) {}

bool Keyboard::isKeyDown(Key k) {
    return glfwGetKey(window->getImpl()->window, getGLFWKeyFromKey(k)) == GLFW_PRESS;
}
}
